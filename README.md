...
| Document | Covers |
|----------|--------|
| [Deployment Lifecycle](docs/deployment-lifecycle.md) | Four-phase delivery process — local, dev, staging, and production, including CI/CD pipeline configuration, k6 load test findings, and key infrastructure decisions |
| [Architecture README](docs/architecture.md) | Full infrastructure reference covering networking, compute, data, autoscaling, blue/green deployment, observability, security, cost decisions, and Terraform module structure |
